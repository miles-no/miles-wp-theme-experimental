...
`,d=document.createElement("template");d.innerHTML=`
  ...
  <div class="heart">
    ...
    `;class it extends HTMLElement{constructor(){super();const e=this.attachShadow({mode:"open"});e.appendChild(v.content.cloneNode(!0)),this.svg=e.querySelector("svg")}static get observedAttributes(){return["width","height","color"]}attributeChangedCallback(e,i,t){e==="width"&&this.svg.setAttribute("width",t),e==="height"&&this.svg.setAttribute("height",t),e==="color"&&this.svg.setAttribute("fill",t)}}const w="miles-heart";customElements.get(w)||customElements.define(w,it);const y=document.createElement("template");y.innerHTML=`
    <style>
      ${s}
    ...
    `;class _ extends HTMLElement{constructor(){super();const e=this.attachShadow({mode:"open"});e.appendChild(k.content.cloneNode(!0)),this.svg=e.querySelector("svg")}static get observedAttributes(){return["width","height","color"]}attributeChangedCallback(e,i,t){e==="width"&&this.svg.setAttribute("width",t),e==="height"&&this.svg.setAttribute("height",t),e==="color"&&this.svg.setAttribute("fill",t)}}const E="miles-bulb";customElements.get(E)||customElements.define(E,_);const M=document.createElement("template");M.innerHTML=`
    <style>
      ${s}
    ...
    <div class="cup">
      ...
      `;class L extends HTMLElement{constructor(){super();const e=this.attachShadow({mode:"open"});e.appendChild(M.content.cloneNode(!0)),this.svg=e.querySelector("svg")}static get observedAttributes(){return["width","height","color"]}attributeChangedCallback(e,i,t){e==="width"&&this.svg.setAttribute("width",t),e==="height"&&this.svg.setAttribute("height",t),e==="color"&&this.svg.setAttribute("fill",t)}}const H="miles-cup";customElements.get(H)||customElements.define(H,L);class S extends HTMLElement{constructor(){super();const e=this.attachShadow({mode:"open"});e.innerHTML=`
        <style>
          ${s}
      ...
      `}}const A="miles-zoom";customElements.get(A)||customElements.define(A,S);const T=document.createElement("template");T.innerHTML=`
        ...
        `;class q extends HTMLElement{constructor(){super();const e=this.attachShadow({mode:"open"});e.appendChild(T.content.cloneNode(!0)),this.svgEl=e.querySelector("path")}static get observedAttributes(){return["color"]}attributeChangedCallback(e,i,t){e==="color"&&(t&&t.length>0?(this.svgEl.setAttribute("fill",t),this.svgEl.style.transform="scale(1.03)"):(this.svgEl.setAttribute("fill","currentColor"),this.svgEl.style.transform="scale(1)"))}}const P="miles-pod";customElements.get(P)||customElements.define(P,q);const z=document.createElement("template");z.innerHTML=`
      <style> 
        :host {
          display: flex;
          align-items: center;
...
`;class $ extends HTMLElement{constructor(){super();const e=this.attachShadow({mode:"open"});e.appendChild(z.content.cloneNode(!0)),this.svgEl=e.querySelector("path")}static get observedAttributes(){return["color"]}attributeChangedCallback(e,i,t){e==="color"&&(t&&t.length>0?this.svgEl.setAttribute("fill",t):this.svgEl.setAttribute("fill","currentColor"))}}const B="miles-phone";customElements.get(B)||customElements.define(B,$);const N=document.createElement("template");N.innerHTML=`
      <style>
        :host {
          display: flex;
          align-items: center;
...
`;class R extends HTMLElement{constructor(){super();const e=this.attachShadow({mode:"open"});e.appendChild(N.content.cloneNode(!0)),this.svgEl=e.querySelector("path")}static get observedAttributes(){return["color"]}attributeChangedCallback(e,i,t){e==="color"&&(t&&t.length>0?this.svgEl.setAttribute("fill",t):this.svgEl.setAttribute("fill","currentColor"))}}const Z="miles-email";customElements.get(Z)||customElements.define(Z,R);const I=document.createElement("template");I.innerHTML=`
  ...
  `;class j extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}).appendChild(I.content.cloneNode(!0))}}const V="miles-play";customElements.get(V)||customElements.define(V,j);const O=document.createElement("template");O.innerHTML=`
      <style></style>
<svg xmlns="http://www.w3.org/2000/svg" height="64" viewBox="0 -960 960 960" width="64">
...
`)}}const K="miles-seek";customElements.get(K)||customElements.define(K,Q);const ot=`:host{display:inline-block;width:inherit;box-sizing:border-box}
...
`;class Y extends HTMLElement{constructor(){super();const e=this.attachShadow({mode:"open"});e.appendChild(U.content.cloneNode(!0)),this.svg=e.querySelector("svg")}static get observedAttributes(){return["width","height","color"]}attributeChangedCallback(e,i,t){e==="width"&&this.svg.setAttribute("width",t),e==="height"&&this.svg.setAttribute("height",t),e==="color"&&this.svg.setAttribute("fill",t)}}const X="miles-logo";customElements.get(X)||customElements.define(X,Y);const rt=`:host{display:inline-block;color:var(--miles_primary_dark);background-color:transparent}a{border-radius:3rem;border:2px solid var(--color);color:var(--color);display:inline-flex;font-weight:700;line-height:21px;padding:13px 1.5rem 11px;text-decoration:none;transition:all .5s ease;white-space:nowrap}a:hover,a.selected{color:var(--miles_primary_light);background-color:var(--color)}a .count{color:var(--miles_primary_dark);font-size:12px;position:relative;top:-.25rem;margin-left:.25rem}a .count:empty{display:none}
`,W=a=>[null,"false"].includes(a)===!1,G=document.createElement("template");G.innerHTML=`
        <style>
          ${s}
          ${rt}
        </style>
      ...
      `;class J extends HTMLElement{constructor(){super();n(this,"count",null);const i=this.attachShadow({mode:"open"});i.append(G.content.cloneNode(!0)),this.buttontarget=i.querySelector("#buttonTarget"),this.countEl=i.querySelector(".count")}static get observedAttributes(){return["href","color","selected","count"]}attributeChangedCallback(i,t,o){i==="href"&&this.buttontarget.setAttribute("href",o),i==="color"&&this.style.setProperty("--color",o),i==="count"&&(o>0?this.countEl.textContent=o:this.countEl.textContent=null),i==="selected"&&(this.buttontarget.setAttribute("aria-selected",W(o)),this.buttontarget.classList.toggle("selected",W(o)))}connectedCallback(){}}const ee="miles-button-anchor";customElements.get(ee)||customElements.define(ee,J);const st=`:host{display:inline-block}*,*:before,*:after{box-sizing:border-box}.profile-card{border-radius:30px;display:flex;flex-direction:column;height:100%;margin-left:auto;margin-right:auto;overflow:hidden;width:100%}.profile-card:hover figure img{transform:scale(1.05)}@media (min-width: 361px){.profile-card{max-width:260px}}.profile-card__info{background-color:var(--miles_secondary_four);display:flex;flex-direction:column;flex:1;min-height:140px;padding:1.2rem}.profile-card figure{aspect-ratio:1/1;background-color:#fff;border-radius:.5rem;margin:0 0 .25rem;overflow:hidden;padding:0;text-align:center}.profile-card figure img{animation:fadeIn 1s cubic-bezier(.46,.03,.05,.99);display:block;filter:grayscale(1);object-fit:cover;width:100%;transition:transform .27s cubic-bezier(.46,.03,.05,.99)}.profile-card .jobtitle{margin-bottom:1rem}.profile-card .jobtitle p{-webkit-box-orient:vertical;-webkit-line-clamp:2;display:-webkit-box;line-clamp:2;overflow:hidden;text-overflow:ellipsis}.profile-card .description{align-items:baseline;display:flex;flex-direction:row;gap:.2rem}.profile-card .location{margin-top:auto}.profile-card h3,.profile-card p{color:var(--miles_primary_light);margin:0}@keyframes fadeIn{0%{opacity:0}to{opacity:1}}
...
`;class Ee extends HTMLElement{constructor(){super();n(this,"toggleMenu",()=>{this.banner.classList.toggle("office-banner--open")});this.attachShadow({mode:"open"}),this.shadowRoot.append(_e.content.cloneNode(!0)),this.banner=this.shadowRoot.querySelector("#banner"),this.triggerEl=this.shadowRoot.querySelector(".js-banner-trigger"),this.backgroundEl=this.shadowRoot.querySelector(".office-banner__background"),this.titleEl=this.shadowRoot.querySelector(".office-banner__title"),this.header=null}static get observedAttributes(){return["background","city"]}attributeChangedCallback(i,t,o){i==="background"&&(this.backgroundEl.style.backgroundImage=`url(${o})`),i==="city"&&(this.titleEl.textContent=o)}connectedCallback(){this.triggerEl.addEventListener("click",this.toggleMenu)}disconnectedCallback(){this.triggerBg.removeEventListener("click",this.toggleMenu)}}const Me="miles-office-banner";customElements.get(Me)||customElements.define(Me,Ee);const gt=`:host{display:inline-block;transition:transform .5s cubic-bezier(.46,.03,.52,.96)}#arrow{justify-content:center;display:flex;width:inherit;height:inherit;align-items:center}:host(.open){transform:rotate(180deg)}svg{width:inherit;height:inherit}
...
`,ze=document.createElement("template");ze.innerHTML=`
  ...
  ${s}
    ...
    `;class $e extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.append(ze.content.cloneNode(!0)),this.headingEl=this.shadowRoot.querySelector("h2")}static get observedAttributes(){return["heading"]}attributeChangedCallback(e,i,t){e==="heading"&&(this.headingEl.textContent=t)}connectedCallback(){}disconnectedCallback(){}}const Be="miles-info-block";customElements.get(Be)||customElements.define(Be,$e);const bt=`:host{display:inline-block;color:inherit;background-color:inherit}#wrapper{background-color:inherit;display:flex;flex-direction:column}h2{margin:0;line-height:33px}a{color:inherit}#address,#phone{margin-bottom:1rem}
...
`,Ie=document.createElement("template");Ie.innerHTML=`
      ...
      `;class je extends HTMLElement{constructor(){super();n(this,"handleKeys",i=>{i.keyCode===13&&this.openmenu(i,!0)});n(this,"openmenu",(i,t)=>{i.preventDefault();const o=this.burgerEl.getAttribute("aria-expanded")==="true"||!1;this.burgerEl.setAttribute("aria-expanded",!o),this.burgerEl.classList.toggle("open-menu"),this.menuContent.classList.toggle("open"),!o&&t&&this.menuContent.querySelector("a").focus()});n(this,"menuIsOpen",()=>this.burgerEl.getAttribute("aria-expanded")==="true"||!1);n(this,"closemenu",i=>{if(!this.menuIsOpen()||this.menuContent.contains(i.target))return;i.preventDefault(),(this.burgerEl.getAttribute("aria-expanded")==="true"||!1)&&(this.burgerEl.setAttribute("aria-expanded",!1),this.burgerEl.classList.remove("open-menu"),this.menuContent.classList.remove("open"),this.burgerEl.focus())});n(this,"stopEventPropagation",i=>{i.stopPropagation()});n(this,"handleEscapeKeydown",i=>{i.key==="Escape"&&this.closemenu(i)});const i=this.attachShadow({mode:"open"});i.append(Ie.content.cloneNode(!0)),this.burgerEl=i.querySelector("#nav-icon"),this.menuContent=i.querySelector("#menu-content"),this.burgerEl.setAttribute("tabindex","0"),this.burgerEl.setAttribute("role","button"),this.burgerEl.setAttribute("aria-haspopup","true"),this.burgerEl.setAttribute("aria-expanded","false"),this.burgerEl.setAttribute("aria-label","Meny")}connectedCallback(){this.shadowRoot.querySelector("slot").assignedElements().forEach(i=>{i.tagName==="NAV"&&(i.querySelector('a[href="#"]')&&i.querySelector('a[href="#"]').remove(),this.menuContent.append(i))}),this.burgerEl.addEventListener("keydown",this.handleKeys),this.burgerEl.addEventListener("click",this.openmenu),document.addEventListener("click",this.closemenu),this.menuContent.addEventListener("click",this.stopEventPropagation),this.burgerEl.addEventListener("click",this.stopEventPropagation),window.addEventListener("keydown",this.handleEscapeKeydown)}disconnectedCallback(){this.burgerEl.removeEventListener("click",this.openmenu),document.removeEventListener("click",this.closemenu),window.removeEventListener("keydown",this.handleEscapeKeydown)}}const Ve="miles-site-menu";customElements.get(Ve)||customElements.define(Ve,je);const wt=`:host{color:var(--miles_primary_light);display:block;margin-bottom:1em;width:100%}.podcast-card{background-color:var(--miles_secondary_four);border-radius:30px;display:flex;flex-direction:column;gap:2rem;overflow:hidden;padding:2rem}@media (min-width: 768px){.podcast-card{flex-direction:row}}.podcast-card__content{flex:1}.podcast-card__image{align-items:center;background-color:#fff;border-radius:10px;display:flex;flex-direction:row;flex:0 0 auto;height:156px;padding:.5rem;width:156px}.podcast-card__title{font-size:2rem;font-weight:700;line-height:1;margin:1rem 0 .5rem}.podcast-card__title:before{content:attr(data-episode);margin-right:.5rem}.podcast-card__date{font-size:.75rem;font-weight:700;margin-bottom:1.5rem}.podcast-card__description{margin:0}
...
`;class Je extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.append(Ge.content.cloneNode(!0)),this.imageBlockElement=this.shadowRoot.querySelector(".image-block"),this.image=this.shadowRoot.querySelector("#image"),this.contentElement=this.shadowRoot.querySelector(".image-block__content")}createButton(e){const i=document.createElement("a");i.setAttribute("class","button"),i.textContent=e,this.contentElement.appendChild(i)}static get observedAttributes(){return["image","color","background","reverse","alt","href","button"]}attributeChangedCallback(e,i,t){if(e==="alt"&&t&&this.image.setAttribute("src",t),e==="image"){const o="https://picsum.photos/540/420";this.image.setAttribute("src",t||o)}if(e==="reverse"&&t==="true"&&this.imageBlockElement.classList.add("image-block--reverse"),e==="color"&&t&&this.style.setProperty("--text-color",t),e==="background"&&t&&this.style.setProperty("--background-color",t),e==="button"&&t&&this.createButton(t),e==="href"){const o=this.shadowRoot.querySelector(".button");t&&o&&o.setAttribute("href",t)}}connectedCallback(){}disconnectedCallback(){}}const et="miles-image-block";customElements.get(et)||customElements.define(et,Je),r.MilesArrow=He,r.MilesArrowNav=ce,r.MilesAudioPlayer=Xe,r.MilesAudioSeek=Q,r.MilesAuthorCard=qe,r.MilesBanner=Ke,r.MilesBlogCard=we,r.MilesBulb=_,r.MilesBusinessCard=p,r.MilesButtonAnchor=J,r.MilesCloud=f,r.MilesContactCard=Re,r.MilesCup=L,r.MilesCurve=x,r.MilesEmail=R,r.MilesFagbloggTeaser=fe,r.MilesImageBlock=Je,r.MilesImageSlider=pe,r.MilesInfo=re,r.MilesInfoBlock=$e,r.MilesLogo=Y,r.MilesOfficeBanner=Ee,r.MilesOverlapBlock=Ce,r.MilesPause=F,r.MilesPhone=$,r.MilesPlay=j,r.MilesPodcastCard=Fe,r.MilesPodcastTeaser=ne,r.MilesPodd=q,r.MilesProfileCard=ie,r.MilesZoom=S,r.SiteMenu=je,Object.defineProperty(r,Symbol.toStringTag,{value:"Module"})});
